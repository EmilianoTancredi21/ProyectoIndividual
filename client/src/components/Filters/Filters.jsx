...
return (
  <div className={styles.containerSelect}>
    <div>
      <select className={styles.selectBox} value={orderBy} onChange={ event => filterOrd(event)}>
    ...
    <div>
      <select className={styles.selectBox} value={filterByBirthdate}  onChange={event => filterByDob(event)}>
        <option defaultValue="0">
          Birthdate
        </option>
      ...
      <div>
      <select className={styles.selectBox} value={filterByOrigin} onChange={(event) => FilterCreatedDriver(event)}>
      <option defaultValue="0">
          Origin
        </option>
